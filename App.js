...
function App() {
  ...
  const handleCompleteTodo = (index) => {
    ...
    setCompletedTodo(reducedCompleteTodo);
    }
      ...
      <div className='todo-wrapper'>
        <div className='todo-input'>
            ...
            <div className='todo-input-item'>
              ...
              <input type='text' value={newDescription} onChange = {(e)=>setNewDescription(e.target.value)}placeholder='what`s the task desp?'/>
            </div>
            <div className='todo-input-item'>
              <label>Title</label>
            ...
            <div className='todo-list'>
              {isCompleteScreen === false && allTodos.map((item,index)=>{
                ...
                <div className='todolist-item' key={index}>
                    ...
                    <div>
                        <AiOutlineDelete  className='icon-delete'onClick={()=>deleteTodo(index)} title='Delete?'/>
                        <AiOutlineCheck className='check-icon' onClick ={()=>handleCompleteTodo(index)} title='Complete?'/>
                    </div>
                </div>
                );
              })}
              ...
              {isCompleteScreen === true && completedTodos.map((item,index)=>{
                              ...
                              <div className='todolist-item' key={index}>
                                  ...
                                  <div>
                                      <AiOutlineDelete  className='icon-delete'onClick={()=>handleDeleteTodo(index)} title='Delete?'/>
                                  </div>
                              </div>
                              );
                            })}
